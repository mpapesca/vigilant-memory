...
export default function GameScreen() {
  ...
  const cardSize = Math.min(
    (screenWidth - 60) / currentLevel.gridSize.cols,
    80
  );
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.infoRow}>
          <View style={[styles.difficultyBadge, { backgroundColor: getDifficultyColor(currentLevel.difficulty) }]}>
            <Text style={styles.difficultyText}>{getDifficultyName(currentLevel.difficulty)}</Text>
          </View>
      ...
      <View style={styles.gameContainer}>
        <View style={[styles.grid, { width: cardSize * currentLevel.gridSize.cols + 20 }]}>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.card,
                  {
                    width: cardSize - 10,
                    height: cardSize - 10,
                    backgroundColor: card.isRevealed || card.isMatched 
                      ? (isDark ? '#2c2c2e' : '#ffffff')
                      : (isDark ? '#1c1c1e' : '#f0f0f0'),
